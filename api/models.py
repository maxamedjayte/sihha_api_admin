...
class AppInformation(models.Model):
    loginPageImage=models.ImageField(upload_to='images/appInfo',null=True,blank=True)
    ...
    subscriptionPageImage=models.ImageField(upload_to='images/appInfo',null=True,blank=True)
...
class ShikhCategory(models.Model):
    ...
    profileImage=models.ImageField(upload_to='images/shikh',null=True,blank=True)
...
class ListeningCilajWithQuran(models.Model):
    name=models.CharField(max_length=255)
    theShikh=models.ForeignKey(ShikhCategory,related_name='dhagaysigaWithMuqaalkaShiiqa',on_delete=models.CASCADE)
    isVideo=models.BooleanField(default=False)
    videoLink=models.CharField(default='',max_length=10000,null=True,blank=True)
    voiceLink=models.CharField(default='',max_length=10000,null=True,blank=True)
    voice=models.FileField(upload_to='voice/listeningCilajWithQuran/',null=True,blank=True,storage=VideoMediaCloudinaryStorage())
...
class AdkarWithTalo(models.Model):
    name=models.CharField(max_length=255)
    voice=models.FileField(upload_to='voice/adkarWithTalo/',null=True,blank=True,storage=VideoMediaCloudinaryStorage())
...
class ProbQuestion(models.Model):
    probQuestionCategory=models.ForeignKey(ProbQuestionCategory,null=True,blank=True,on_delete=models.CASCADE)
    nuucaSuaasha=models.CharField(max_length=255,choices=DADKA_SUAASHAN,default='dadwaawayn')
    ...
    desc=models.TextField(null=True,blank=True)
    isTrueAdkarWithTaloyin=models.ManyToManyField(AdkarWithTalo,null=True,blank=True)
...
class UserProfile(models.Model):
    ...
    profileImage=models.ImageField(upload_to='images/userProfile',null=True,blank=True)
    city=models.CharField(default='Mogadishu',max_length=33)
    password=models.CharField(max_length=255)
    sex=models.CharField(max_length=255)
    age=models.IntegerField(default=15)
    userMatchedAdkarWithTalo=models.ManyToManyField(AdkarWithTalo,null=True,blank=True)
...
class ProbAnswer(models.Model):
    theProbQuestion=models.ForeignKey(ProbQuestion,on_delete=models.CASCADE,default=1)
    theUser=models.ForeignKey(UserProfile,on_delete=models.CASCADE)
    desc=models.TextField(null=True,blank=True)
...
class ChildProbAnswer(models.Model):
    ...
    theUser=models.ForeignKey(UserProfile,on_delete=models.CASCADE,null=True,blank=True)
    desc=models.TextField(null=True,blank=True)
    answer=models.BooleanField(default=False)
    created=models.DateField(auto_now=True)
    updated=models.DateField(auto_now=True)
...
class DoctorAppointment(models.Model):
    ...
    appointmentMeetingLink=models.CharField(max_length=255,null=True,blank=True)
    userRate=models.IntegerField(default=3)
    theCategory=models.ForeignKey(AppointmentCategory,on_delete=models.CASCADE)
...
class UserAnswerInformation(models.Model):
    theUser=models.ForeignKey(UserProfile,on_delete=models.CASCADE)
    thePorbQuestionCategory=models.ForeignKey(ProbQuestionCategory,on_delete=models.CASCADE)
...
class UserChildAdkarWithProduct(models.Model):
    ...
    childMatchedAdkarWithTalo=models.ManyToManyField(AdkarWithTalo,null=True,blank=True)
